      ...
      <div className="card-body px-4 mt-3">
        ...
        <div className=' ' style={{}}>
          <button className="btn btn-dark 
                    " style={{
              width: "235px", height: "40px", borderRadius: "5px", marginRight: -226
            }}>
            <img src={shopingcardicon} style={{
              width: "19.325px",
              height: "18.329px", color: "#FFFFFF"
            }}
              alt="" /> <span style={{
                fontFamily: "inter", fontStyle: "normal",
                lineHeight: "normal", fontWeight: 500, fontSize: "14px", color: "#FFFFFF"
              }}> ADD TO CART</span>
          </button>
        </div>
