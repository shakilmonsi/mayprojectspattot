...
import "./RecommendedForYousPrdoductDitilspageCard.css"
const RecommendedForYousPrdoductDitilspageCard = ({ service }) => {
    ...
    <div
      ...
      <div className="card-body px-4 mt-2" >
        ...
        <div className="d-flex justify-content-between mt-2" style={{ color: "#2A2A2A", fontSize: "16px", fontFamily: "inter", fontStyle: "normal", fontWeight: 600, lineHeight: "normal" }}>
          ...
          <p style={{}}>
            <del style={{
              color: "#FF5530", fontSize: "12px", fontFamily: "inter",
              fontWeight: 600, textDecorationLine: "strikethrough", lineHeight: 'normal'
            }}>{delprice}</del>
          </p>
        </div>
...
export default RecommendedForYousPrdoductDitilspageCard;